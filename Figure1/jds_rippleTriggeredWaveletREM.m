function jds_rippleTriggeredWaveletREM(animalprefixlist, days)
%JDS_RIPPLETRIGGEREDWAVELETREM Ripple-triggered wavelet spectrogram in REM.
%   jds_rippleTriggeredWaveletREM(animalprefixlist, days) computes the
%   session-z-scored Morlet wavelet spectrogram around cortical REM ripple
%   onsets on the ctxriptet with the most ripples and plots the mean
%   spectrogram across animals.
%
%   animalprefixlist - cell array of animal prefix strings
%   days             - vector of experiment days
