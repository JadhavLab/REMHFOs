...
%JDS_XCORRREM Cortical ripple autocorrelations in NREM vs REM.
%   [autocorrSWS, autocorrREM] = jds_xCorrREM(animalprefixlist) computes
%   the z-scored, smoothed autocorrelogram of cortical ripple start times
%   separately for NREM and REM (center bins masked), tests each time bin
%   between states (sign-rank), and plots the two mean autocorrelograms
%   with significant bins marked.
%
