...
%   2-s windows around REM ripple-chain midpoints, along with a
%   trigger-shuffled control, and plots the PSI spectrum and theta-band
%   (6-12 Hz) summary. Positive values indicate CA1 leading.
%
%   animalprefixlist - cell array of animal prefix strings
%
%   Requires the FieldTrip toolbox (edit the addpath below).
