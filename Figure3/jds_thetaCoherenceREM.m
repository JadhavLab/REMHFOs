function jds_thetaCoherenceREM(animalprefixlist,Hz)
...
%   epoch), along with a circular-shift shuffle, saves the per-pair
%   coherence data, and plots the mean cohereogram and the coherence time
%   course within the frequency band Hz = [lo hi].
%
%   animalprefixlist - cell array of animal prefix strings
%   Hz               - two-element frequency band, e.g. [6 12]
