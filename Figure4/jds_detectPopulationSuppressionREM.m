...
%   below threshold, 0.3-0.5 s long) within the loaded sleep-state bouts,
%   using the population spike matrix for 'CA1' or PFC (any other value of
%   area). Saves trough times, event waveforms, and circular-shift shuffle
%   events to <animal>PFCNREMmuasuppression<day>.mat, and plots the mean
%   suppression waveform and peri-suppression cortical ripple histogram.
%   NOTE: as configured this runs on NREM (SWS) bouts and SWS cortical
%   ripples.
%
%   animalprefixlist - cell array of animal prefix strings
%   area             - 'CA1' for hippocampal spike matrix, otherwise PFC
