%jds_sleepStateRipplePrediction
...
%and F-score, and plots data vs shuffle accuracy.
...
if savedata
    save(sprintf('%s%sREMvsNREMRipplePrediction.mat',saveDir,rtype), 'animDataRipSplit');
end
