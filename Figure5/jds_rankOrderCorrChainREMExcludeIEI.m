...
%   event spanning the chain, with spikes in the between-ripple gaps
%   excluded), the correlation between each event's PFC cell firing-order
%   ranks and the mean ranks across all other events of the same type, and
%   compares REM vs NREM rank-order correlations (rank-sum, bar plot).
%
%   animalprefixlist - cell array of animal prefix strings
%   day              - experiment day
%   cellcountthresh  - minimum number of active cells per event
