...
%   each cortical ripple chain in REM and in NREM (SWS), compares peak
%   reactivation between states (rank-sum), and plots mean traces and
%   per-assembly heatmaps under several sortings.
%
