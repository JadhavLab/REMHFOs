...
%   ripple-chain midpoints, separately for theta-phase shifter vs
%   nonshifter cells: pairwise phase consistency, Von Mises kappa, and
%   preferred phase (Watson's U2), with phase-locking PDFs.
%
