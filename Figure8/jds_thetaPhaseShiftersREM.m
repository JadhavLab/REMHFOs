...
%   classifies cells whose preferred phase shifts by more than 90 degrees
%   as shifters (both phase distributions must be significantly nonuniform).
%   Optionally saves the shifter list (savedata) and plots phase-locking
%   PDFs, wake-vs-REM phase distributions (Watson's U2), the run-vs-REM
%   phase scatter, and the shift-magnitude histogram.
%
